...
app.post('/play', (req, res) => {
    ...
    const device = devices.find(d => d.friendlyName === deviceName) ||
...
app.get('/test', (req, res) => {
    ...
    const targetDevices = devices.filter(d =>
        d.friendlyName.includes("Google Display") || d.friendlyName.includes("Nest") || d.friendlyName.includes("Home")
    );
    ...
    if (!deviceName) {
        ...
        const listHtml = targetDevices.map(d => {
